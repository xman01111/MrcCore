    ...
    class DbCommandInterceptor : IDbCommandInterceptor
    {
        ...
        public static string AppendDbCommandInfo(IDbCommand command)
        {
            ...
            foreach (IDbDataParameter param in command.Parameters)
            {
                ...
                sb.AppendFormat("{3} {0} {1} = {2};", System.Enum.GetName(typeof(DbType), param.DbType), param.ParameterName, value, System.Enum.GetName(typeof(ParameterDirection), param.Direction));
                sb.AppendLine();
            }
